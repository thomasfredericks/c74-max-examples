...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 415.0, 520.0, 373.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 415.0, 566.5, 203.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 520.0, 377.0, 20.0 ],
					"text" : "jit.anim.node @position -0.5 0 0 @rotatexyz 0 0 0 @scale 0.5 0.5 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "introduction au 3D/02-deux surfaces"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 20.0, 566.5, 203.0, 20.0 ],
					"text" : "jit.gl.videoplane @texture 3dglasses"
				}
