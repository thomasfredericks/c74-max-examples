...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 913.0, 694.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 913.0, 651.0, 32.5, 20.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1012.0, 569.5, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 900.0, 507.0, 53.0, 20.0 ],
					"text" : "unjoin 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.0, 569.5, 103.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 913.0, 737.0, 252.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.0, 687.0, 99.0, 20.0 ],
					"text" : "prepend position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.0, 637.0, 32.5, 20.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 749.0, 555.5, 99.0, 20.0 ],
					"text" : "scale 0 480 1. -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 637.0, 493.0, 53.0, 20.0 ],
					"text" : "unjoin 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 637.0, 555.5, 103.0, 20.0 ],
					"text" : "scale 0 640 -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 637.0, 458.0, 281.0, 20.0 ],
					"text" : "route /lefthand_pos_screen /righthand_pos_screen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 650.0, 730.0, 246.0, 20.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "EXEMPLE-SYNAPSE-2D.json",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-4",
					"maxclass" : "newobj",
...
, 			{
				"name" : "EXEMPLE-SYNAPSE-intro.json",
				"bootpath" : "/Volumes/Disque Dur/introduction_presto_a_max",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
